...
export default function TermsAndConditionsComponent({
  ...
  const handleDownload = () => {
    ...
    link.download = `${companyName.toLowerCase().replace(/\s+/g, "-")}-terms-and-conditions.txt`;
    link.click();
  };

  const generateTextContent = () => {
    let content = `${companyName} - Terms & Conditions\n`;
  ...
  return (
    ...
    >
      ...
      <div
        className="pointer-events-none absolute inset-0 bg-gradient-to-br from-slate-100 to-red-100 opacity-10"
        style={{
      ...
      <div className="relative z-10 mb-12 text-center">
        <div className="mb-4 flex items-center justify-center">
          <Gavel className="mr-4 text-red-500" size={48} strokeWidth={1.5} />
      ...
      <div className="relative z-10 space-y-8">
        {sections.map((section) => {
          const IconComponent = section.icon || Scale;
          return (
      ...
      <div className="relative z-10 mt-12 text-center text-sm text-slate-500 print:hidden">
        <div className="flex items-center justify-center">
          ...
          />
          <p>
            By using our service, you agree to these Terms & Conditions. Contact
            us at legal@{companyName.toLowerCase().replace(/\s+/g, "")}.com for
            any inquiries.
          </p>
        </div>
      </div>
